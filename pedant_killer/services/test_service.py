...
from pedant_killer.schemas.common_schema import BaseModel
from pedant_killer.schemas.device_schema import DevicePartialDTO, BaseIdDTO
...
async def ggvp():
    ...
    access_level_dto = BaseIdDTO(id=9)
